...
async def process_voice_journal(
    ...
    # Handle failed speech transcription
    ...
    # Get transcript text
    journal_text = result.get("transcript", "")
    ...
    metadata = JournalMetadata(
        ...
        low_confidence_emotion=result.get(
            "low_confidence_emotion", False
        ),
        stt_failure=False,
        acoustic_excluded=result.get(
            "acoustic_excluded", False
        ),
    )
    ...
    emotion_vectors_col.insert_one(to_python({
        ...
        "active_emotions":
            result.get("active_emotions", []),
        "confidence":
            result.get("confidence", 0.0),
        "acoustic_scores":
            result.get("acoustic_scores", {}),
        "dominant_acoustic":
            result.get("dominant_acoustic", ""),
        "acoustic_excluded":
            result.get("acoustic_excluded", False),
